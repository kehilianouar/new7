      ...
      <Head>
        <title>
          {data?.main?.title || data?.main?.name
            ? `${data.main.title || data.main.name} - DADA GYM STORE `
            : "DADA GYM STORE"}
        </title>
        ...
        <meta
          ...
          content={
            (data?.main?.overview
              ? `${data.main.overview} — DADA GYM STORE`
              : "DADA GYM STORE")
          }
        />
        <link
        ...
        />
        <meta name="twitter:creator" content="@gymdada" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: data?.main?.title || data?.main?.name || "DADA GYM STORE",
