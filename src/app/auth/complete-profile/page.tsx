...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center p-2 md:p-4 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 bg-cover bg-center relative overflow-hidden">
      {/* خلفيات ديكوريشن */}
