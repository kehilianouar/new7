...
const exploreLinks = [
  { href: "/products?filter=bestsellers", label: "الأكثر مبيعاً", },
  { href: "/products?filter=sale", label: "العروض الخاصة", },
  { href: "/products?category=supplements", label: "المكملات الغذائية", },
  { href: "/products?category=clothing", label: "الملابس الرياضية", },
]
            ...
            <div className="flex items-center gap-3 group">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-white/10 to-white/5 p-1 rounded-2xl border border-white/10">
                  <Image
                    src="/images/gymdada.webp"
                    width={55}
                    height={55}
                    alt="DADA GYM STORE LOGO"
              ...
              <div>
                ...
                <p className="text-xs font-medium">متجر GYM DADA STORE - أفضل متجر للمكملات الغذائية والملابس الرياضية</p>
              </div>
            </div>

            <div className="space-y-3">
              <p className="text-gray-300 leading-relaxed text-xs md:text-sm">
                متجر GYM DADA STORE - أفضل متجر للمكملات الغذائية والملابس الرياضية في الجزائر. منتجات أصلية، توصيل مجاني، دفع عند الاستلام.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-3">
            <div className="text-center md:text-right">
              <p className="text-white/70 text-xs md:text-sm">
                © {new Date().getFullYear()} <span className="text-primary font-medium">GYM DADA STORE</span>. كل الحقوق
                محفوظة.
              </p>
            </div>
