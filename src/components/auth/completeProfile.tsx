...
export default function CompleteProfile() {
  ...
  } = useForm<z.infer<typeof completeProfileSchema>>({
  ...
  const handleSave = async (data: z.infer<typeof completeProfileSchema>) => {
    ...
    await saveUserProfile(user.uid, {
      ...
      favoriteProducts: [], // Initialize with empty array
      recentViews: [] // Initialize with empty array
    });
        ...
        <Popover>
          ...
          <PopoverContent className="w-auto p-0">
            <Calendar
              ...
              onSelect={(date) =>
                setValue("birthdate", date ? date.toLocaleDateString("en-CA") : "")
              }
